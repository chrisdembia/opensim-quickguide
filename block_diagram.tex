...
\begin{tikzpicture}[
    ...
    \node (body2) [draw, below=of j2] {Body "b2"};

    % Actuator.
    \node (actu1) [draw, left=of c1, inner ysep=1em, inner xsep=2em]
    ...
    \node (actu2) [draw, left=of c2, inner ysep=1em, inner xsep=2em]
    ...
    \node (contr) [draw, left=25em of body1, inner ysep=2em, inner xsep=2em]
    ...
    % Data source.
    \node (datasrc) [draw, left=5em of contr, inner ysep=1em, inner xsep=2em]
    {DataSource "traj"};
    ...
    % Reporter.
    \node (rep) [draw, right=10em of body1, inner sep=2em] {FileReporter};
